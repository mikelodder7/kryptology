...
// WriteChallengeContributionToTranscript returns the bytes that should be added to
// a sigma protocol transcript for generating the challenge.
func (pok *PokSignature) WriteChallengeContributionToTranscript(transcript *merlin.Transcript) {
