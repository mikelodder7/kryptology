...
func bls12381g2InitAll() {
	...
	bls12381g2.N = bls12381.FqNew().Params.BiModulus
...
func (*Bls12381G2Curve) IsOnCurve(x, y *big.Int) bool {
	_, err := new(bls12381.G2).SetBigInt(x, y)
	return err == nil
}

func (*Bls12381G2Curve) Add(x1, y1, x2, y2 *big.Int) (*big.Int, *big.Int) {
...
func (*Bls12381G2Curve) Double(x1, y1 *big.Int) (*big.Int, *big.Int) {
...
func (*Bls12381G2Curve) ScalarMult(capBx, capBy *big.Int, k []byte) (*big.Int, *big.Int) {
	p, err := new(bls12381.G2).SetBigInt(capBx, capBy)
	if err != nil {
		return nil, nil
	}
	var bb [native.FieldBytes]byte
	copy(bb[:], k)
	s, err := bls12381.FqNew().SetBytes(&bb)
	if err != nil {
		return nil, nil
	}
...
func (*Bls12381G2Curve) ScalarBaseMult(k []byte) (*big.Int, *big.Int) {
...
func (*Bls12381G2Curve) Hash(msg []byte) (*big.Int, *big.Int) {
...
func (*Bls12381G2Curve) CompressedBytesFromBigInts(x, y *big.Int) ([]byte, error) {
