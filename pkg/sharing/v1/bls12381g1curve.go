...
func bls12381g1InitAll() {
	...
	bls12381g1.N = bls12381.FqNew().Params.BiModulus
...
func (*Bls12381G1Curve) IsOnCurve(x, y *big.Int) bool {
	_, err := new(bls12381.G1).SetBigInt(x, y)
	return err == nil
}

func (*Bls12381G1Curve) Add(x1, y1, x2, y2 *big.Int) (*big.Int, *big.Int) {
...
func (*Bls12381G1Curve) Double(x1, y1 *big.Int) (*big.Int, *big.Int) {
...
func (*Bls12381G1Curve) ScalarMult(capBx, capBy *big.Int, k []byte) (*big.Int, *big.Int) {
	p, err := new(bls12381.G1).SetBigInt(capBx, capBy)
	if err != nil {
		return nil, nil
	}
...
func (*Bls12381G1Curve) ScalarBaseMult(k []byte) (*big.Int, *big.Int) {
...
func (*Bls12381G1Curve) Hash(msg []byte) (*big.Int, *big.Int) {
...
func (*Bls12381G1Curve) CompressedBytesFromBigInts(x, y *big.Int) ([]byte, error) {
